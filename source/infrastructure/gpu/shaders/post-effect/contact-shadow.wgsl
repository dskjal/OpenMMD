...
fn load_depth(coord: vec2<i32>) -> f32 {
    ...
    return linearize_depth(contactShadowUniforms, textureLoad(t_depth, clamped, 0));
}
...
@fragment
fn fs_contact_shadow_composite(@builtin(position) pos: vec4<f32>) -> @location(0) vec4<f32> {
